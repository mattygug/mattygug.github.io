var Bg, CheckoutBG, CollectionBG, Dot, Filter, FilterGroupA, HoverImage, HoverInfo, IconBuy, IconCollection, IconMore, IconSearch, IconSelector, IconSeparator1, IconSeparator2, IconSeparator3, IconSeparator4, IconSeparator5, IconSeparator6, IconSettings, Menu, MenuTriangle, MenuTriangleb, Menugray, More, MoreCover, MoreText1, MoreText2, MoreText3, Profile, SearchActive, SearchActiveA, SearchActiveB, SearchBG, SearchBar, SearchFilter, SearchFilters, SearchInput, checkoutoff, checkouton, collectionoff, collectionon, filteroff, filteron, morebigscreen, moreoff, pulse, searchin, searchoff, searchon, timedot, timefilter, timeselect, timeslider, triangleblack, trianglewhite;
...
checkoutoff = function() {
  return CheckoutBG.states["switch"]("one");
};
...
HoverInfo.on(Events.MouseOut, function() {
  return HoverImage.states["switch"]("hidden");
});
